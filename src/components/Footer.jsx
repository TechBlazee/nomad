          ...
          >
            <div className=" mb-4 sm:w-4/5 sm:mb-0">
              ...
              <input
                ...
                required
                className="inputFill sm:w-full placeholder:text-sm sm:placeholder:text-base lg:placeholder:text-lg"
              />
            </div>
            <div className=" sm:col-span-2 sm:w-fit place-content-end">
              <button type="submit" className="primaryBtn sm:w-auto sm:ml-auto">
                Subscribe
              </button>
